    ...
    mainPanel(
      ...
      conditionalPanel(
        ...
        tags$p(
            ...
            tableOutput(outputId = "exampleMapping") 
          )
      ),
...
server <- function(input, output, session) {
  ...
  output$exampleMapping
<- renderTable({
    # create example mappings table
    exMappingTable <- data.frame(
      Gene =  c("gene-LOC124194901", "gene-LOC124206286", "gene-LOC124190556", "gene-LOC124190357", "gene-LOC124198912"),
      GO = c("GO:0005730,GO:0030490", "GO:0006890,GO:0030173,GO:0005783,GO:0006621", "GO:0061575,GO:0045737,GO:0016301,GO:0016533", "GO:0006355", "GO:0005739,GO:0008203,GO:0006744,GO:0015039")
    )
  })
